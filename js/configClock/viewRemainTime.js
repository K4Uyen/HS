            ...
            if(this.remainTime != "NEW_YEAR") {
                ...
                setInterval(()=>{
                    switch(this.x){
                        ...
                        break;
                        case 3:
                            this.elementTime = [31, 14, 36, 36, 36, 36, 36, 36];
                            ++this.x;
                        break;
                         case 4:
                            this.elementTime = [23, 17, 10, 36, 36, 36, 36, 36];
                            ++this.x;
                        break;
                         case 5:
                            this.elementTime = [11, 10, 23, 36, 36, 36, 36, 36];
                            ++this.x;
                        break;
                        case 6:
                            this.elementTime = [30, 34, 14, 23, 36, 36, 36, 36];
                            ++this.x;
                               break;
